...
# --------------------------------------
# File: 03_scripts/02_random_forests/08_rf_pisa_contextual_ict_outside_domains.R
# Purpose:
...
# PISA 2022 analysis. It estimates variable importance for each outside-school
# domain using valid non-input, non-COVID outside-class predictors across
# mathematics, reading, and science plausible values, then produces aggregated
# importance summaries, domain-level top-20 plots, and selected partial
# dependence plots.
#
# Main tasks:
# 1. Load the analysis-ready dataset and mapping file.
# 2. Exclude selected flag-based cases.
# 3. Identify eligible predictors for each outside-school domain.
...
output_folder_base <- file.path("PATH_TO_LOCAL_OUTPUT", "random_forests", "pisa_contextual_ict_outside", "domains")
