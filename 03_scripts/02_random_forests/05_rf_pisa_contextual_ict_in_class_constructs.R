...
# --------------------------------------
# File: 03_scripts/02_random_forests/05_rf_pisa_contextual_ict_in_class_constructs.R
# Purpose:
...
# 2022 analysis. It estimates variable importance for ICT-related and contextual
# in-class constructs across mathematics, reading, and science plausible values,
# then produces aggregated importance summaries, construct-level top-20 plots,
# and selected partial dependence plots.
#
# Main tasks:
...
output_folder_base <- file.path("PATH_TO_LOCAL_OUTPUT", "random_forests", "pisa_contextual_ict_in_class", "constructs")
...
# contextual constructs before running construct-level models.
