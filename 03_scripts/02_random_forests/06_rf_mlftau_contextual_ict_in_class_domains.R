# --------------------------------------
# Random Forest Model: MLFTAU Contextual ICT In-Class Domains
# --------------------------------------
# File: 03_scripts/02_random_forests/06_rf_mlftau_contextual_ict_in_class_domains.R
# Purpose:
# This script runs the implemented domain-level random forest models for the
# MLFTAU contextual ICT in-class framework used in the published Thailand PISA
# 2022 analysis. It estimates variable importance for each MLFTAU domain using
# valid non-input, non-COVID in-school predictors across mathematics, reading,
...
# 3. Identify eligible predictors for each MLFTAU in-class domain.
...
output_folder_base <- file.path("PATH_TO_LOCAL_OUTPUT", "random_forests", "mlftau_contextual_ict_in_class", "domains")
