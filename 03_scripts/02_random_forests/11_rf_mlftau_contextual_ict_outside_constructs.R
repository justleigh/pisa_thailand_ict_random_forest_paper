# --------------------------------------
# Random Forest Model: MLFTAU Contextual ICT Outside-School Constructs
# --------------------------------------
# File: 03_scripts/02_random_forests/11_rf_mlftau_contextual_ict_outside_constructs.R
# Purpose:
...
# PISA 2022 analysis. It estimates variable importance for outside-school
# MLFTAU constructs and their associated domains across mathematics, reading,
# and science plausible values, then produces aggregated importance summaries,
...
# 3. Identify eligible predictors for each MLFTAU construct and associated domain.
...
output_folder_base <- file.path("PATH_TO_LOCAL_OUTPUT", "random_forests", "mlftau_contextual_ict_outside", "constructs")
...
# -----------------------------------------------
# The implemented workflow identifies all eligible MLFTAU outside-school
# constructs from the filtered mapping table before pairing each construct
# with its associated domain(s).
